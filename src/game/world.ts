...
export const staticColliders: Collider[] = [
  ...
  box("office-back", "office", 0, -13.2, 29.7, 0.825, 8),
  box("office-west", "office", -14.85, 0.66, 0.825, 29.04, 8),
  box("office-east", "office", 14.85, 0.66, 0.825, 29.04, 8),
  box("office-front", "office", 0, 14.52, 29.7, 0.66, 8),
  ...[-1, 1].flatMap((s) =>
    [-5, 5].map((z) =>
      box(
        "bookcase-" + s + "-" + z,
  ...
  box("desk", "office", 0, -8.25, 6.2, 2.35, 2.2),
  box("chair", "office", 0, -9.55, 1.5, 0.5, 2.6),
  ...[-1, 1].flatMap((s) => [
    box("sofa-" + s, "office", s * 9.9, 1.65, 2, 3.7, 1.2, true),
    box("sofa-back-" + s, "office", s * 10.7, 1.65, 0.4, 3.7, 1.75),
    ...[-5, 12].flatMap((z, i) => [
