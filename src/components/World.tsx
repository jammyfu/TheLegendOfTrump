...
export function Office() {
  return (
    <group>
      <Box position={[0, -0.15, 0]} scale={[19, 0.3, 20]} color="#856343" />
      {Array.from({ length: 18 }, (_, i) => (
        <Box
          key={i}
          position={[-8.5 + i, 0.005, 0]}
          scale={[0.025, 0.01, 19]}
          color="#a17e56"
        />
      ))}
      ...
      <mesh position={[0, 0.055, 0]} rotation={[-Math.PI / 2, 0, 0]}>
        <ringGeometry args={[5.23, 5.4, 48]} />
        <meshStandardMaterial color="#c6a865" />
      </mesh>
      <mesh position={[0, 0.06, 0]} rotation={[-Math.PI / 2, 0, 0]}>
        <ringGeometry args={[1.8, 1.9, 32]} />
        <meshStandardMaterial color="#b69a58" />
      </mesh>
      {Array.from({ length: 16 }, (_, i) => (
        <mesh
          key={i}
          position={[
            Math.sin((i * Math.PI) / 8) * 4.7,
            0.065,
            Math.cos((i * Math.PI) / 8) * 4.7,
          ]}
          rotation={[-Math.PI / 2, 0, (i * Math.PI) / 8]}
        >
          <circleGeometry args={[0.13, 5]} />
          <meshStandardMaterial color="#dbbc73" />
        </mesh>
      ))}
      <Box position={[0, 4, -8]} scale={[18, 8, 0.5]} color="#e5d4ad" />
      {[-1, 1].map((s) => (
        <Box
          key={s}
          position={[s * 9, 4, 0]}
      ...
      {[-6, -3, 0, 3, 6].map((x) => (
        <group key={x} position={[x, 0, -7.68]}>
          <Box position={[0, 4, 0]} scale={[2.2, 5.9, 0.15]} color="#f1e8c9" />
          <Box
            position={[0, 4, 0.11]}
            scale={[1.9, 5.6, 0.06]}
            color="#8bb6c5"
      ...
      <Flag position={[-4.6, 0, -5.8]} scale={1.15} />
      <Flag position={[4.6, 0, -5.8]} scale={1.15} />
      <Box position={[0, 1, -5]} scale={[5.7, 2, 1.9]} color="#5d3e2b" />
      <Box position={[0, 2.04, -5]} scale={[6.2, 0.23, 2.35]} color="#795536" />
      {[-2.2, -1.1, 0, 1.1, 2.2].map((x) => (
        <group key={x}>
          ...
          <Box
            position={[x, 1, -3.92]}
            scale={[0.65, 1.15, 0.07]}
            color="#67452e"
          />
        </group>
      ))}
      <Box position={[0, 1.3, -6.3]} scale={[1.5, 2.6, 0.35]} color="#674734" />
      <Box
        position={[0, 1.4, -6.07]}
        scale={[1.25, 2.1, 0.15]}
        color="#896147"
      ...
      />
      <Box
        position={[0.6, 2.24, -4.65]}
        scale={[0.06, 0.04, 0.8]}
        color="#c9a45f"
        rotation={[0, -0.1, 0]}
      />
      <Box position={[-2, 2.3, -5]} scale={[0.8, 0.35, 0.5]} color="#22322d" />
      <Cylinder
        position={[2, 2.56, -5]}
        radius={0.13}
        rise={0.8}
      ...
      {[-1, 1].map((s) => (
        <group key={s}>
          ...
          />
          <Box
            position={[s * 6.8, 1.2, 1]}
            scale={[0.4, 1.1, 3.7]}
            color="#d6c49c"
          />
          <Tree x={s * 7} z={-5} size={0.55} />
        </group>
      ))}
    </group>
  );
