...
![繁體中文桌面版標題畫面](artifacts/readme-zh-hk-desktop.png)
...
收集 8 枚翡翠、進入白宮、擊敗鐵甲統領，再前往書桌完成章節。守衛和 Boss 會預警攻擊；格擋、翻滾和跳躍是主要應對方式。

寶箱提供劍盾、弓與箭矢；空手可連擊或長按蓄力重拳。完全蓄滿後繼續按住會耗體力，維持格擋亦會耗體力；體力不足時格擋會破防並損失半顆心。

支援鍵盤滑鼠與觸控操作。暫停或失焦會停止模擬；進度只保存於本次會話。

![繁體中文手機版標題畫面](artifacts/readme-zh-hk-mobile.png)
