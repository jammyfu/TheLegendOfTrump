...
宝箱から剣盾、弓、矢を入手できます。武器を入手する前でも、左ジャブ、右ストレート、前蹴りによる低威力・短距離の素手コンボを使えます。三段斬り、溜め回転斬り、弓の溜め撃ち、ロックオン、スタミナ管理をデスクトップとタッチ操作で利用できます。ポーズまたはフォーカス喪失時はシミュレーションが停止し、進行はこのセッションのみです。

素手の攻撃を長押しすると重拳を溜められます。最大まで溜めた後も押し続けるとスタミナが少しずつ減り、離すと強い打撃、ノックバック、ヒットストップが発生します。ガードを維持している間もスタミナを消費します。成功したガードは毎回 40 のスタミナ区画を1つ使い、1区画に満たない場合はガードが崩れてスタミナが尽き、ハート半分を失います。HUD には半分のハートも表示されます。
